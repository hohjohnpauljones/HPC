...
void goldenSquare(float *arr, float* result, unsigned int count);
...
int main(int argc, char* argv[])
{
	...
	char *kernelSource = ocltLoadKernelSrc("square.cl", &kernelLength);
	...
	std::cout << "Maximum Work-Group Size for Device: " << local << std::endl;
	...
	timer.split();
	goldenSquare(data, goldenResult, count);
